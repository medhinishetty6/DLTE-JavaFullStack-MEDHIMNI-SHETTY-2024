 ...
 * 
 */
@WebServiceClient(name = "TransactionSoapService", targetNamespace = "http://web/", wsdlLocation = "http://localhost:1010/findAllByType?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:1010/findAllByType?wsdl");
